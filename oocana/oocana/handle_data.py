...
class HandleDef:
    ...
    """If the handle is an additional handle, this filed is not original filed, it is generated by oocana. If True, the handle is an additional handle, otherwise it is a normal handle."""
